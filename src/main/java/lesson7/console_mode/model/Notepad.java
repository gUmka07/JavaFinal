package lesson7.console_mode.model;

import lesson7.console_mode.model.fileUtils.FileWorker;
...
public class Notepad {
    ...
    private int hash;
    public static final String FOLDER_PATH = "src/main/resources/notepads";
    ...
    public void open(String fileName) throws IOException {
        ...
        this.fileWorker = new FileWorker(FOLDER_PATH, fileName);
    ...
    public void create(String fileName) throws IOException {
        ...
        fileWorker.create(FOLDER_PATH, fileName);
    }
